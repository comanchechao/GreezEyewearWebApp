export default function navbar() {
    ...
    return(
        <div
    className="w-screen bg-opacity-20 bg-red-500 z-10 Navbar h-16 flex flex-col fixed lg:px-8 lg:justify-between justify-center align-center text-3xl border-b border-gray-200"
  >
    <div className="flex align-center h-full justify-around flex-row items-center">
        ...
        >
          <h1 className="text-2xl mr-2">home</h1>
        </button>
        <button
          className="text-white font-extrabold hidden lg:flex align-center"
        >
          <h1 className="text-2xl mr-2">shop</h1>
        </button>
    </div>
