...
export default function ShoppingMenu() {
  ...
  return (
    <div className=" h-32 pr-28 fixed bg-mainCream flex flex-col lg:flex-row flex-wrap justify-center space-y-3 lg:space-y-0 lg:justify-start space-x-3 lg:pl-6 items-center text-2xl">
