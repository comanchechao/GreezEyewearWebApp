export default function navbar() {
  return (
    <div className="w-screen bg-Rose-700 z-10 Navbar h-20 flex flex-col fixed lg:px-8 lg:justify-between justify-center align-center text-3xl border-b border-gray-200">
